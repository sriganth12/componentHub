  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-6">Order Placed!</h2>
        <p className="text-gray-600 dark:text-gray-400 mt-2">Thank you for your order. We've received it and are getting it ready for you.</p>
        <button
          onClick={handleClose}
